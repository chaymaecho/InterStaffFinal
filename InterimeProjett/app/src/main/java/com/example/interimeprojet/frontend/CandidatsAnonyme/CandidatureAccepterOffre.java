...
public class CandidatureAccepterOffre extends BaseAdapter {
    ...
    public CandidatureAccepterOffre(Context context, List<Offre> offreItems){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.okitem_candidature_accept, parent, false);
        }
