...
public class Candidat_LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.okactivity_login_candidat);
        ...
        recherche.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent().setClass(Candidat_LoginActivity.this, EmployerDernierOffre.class);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Vous pouvez ajouter ici le code pour valider à la fois l'agence et le candidat
                ...
                dialogView.findViewById(R.id.btnReset).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (TextUtils.isEmpty(userEmail) && !Patterns.EMAIL_ADDRESS.matcher(userEmail).matches()) {
                            Toast.makeText(Candidat_LoginActivity.this, "Entrez votre adresse email enregistrée", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        auth.sendPasswordResetEmail(userEmail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(Candidat_LoginActivity.this, "Vérifiez votre e-mail", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                            }
                        });
                    }
    ...
    private void enableLocation() {
        ...
        if (locationManager != null) {
            if (!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                // Si le fournisseur GPS n'est pas activé, affichez une intention pour l'activer
