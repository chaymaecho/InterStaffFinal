...
public class PublierOffrePourTT extends FirebaseRecyclerAdapter<Offres, PublierOffrePourTT.PublishedVacancyHolder> {
     ...
     * @param options
     */
    public PublierOffrePourTT(@NonNull FirebaseRecyclerOptions<Offres> options) {
        super(options);
    }
        ...
        holder.btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final DialogPlus dialogPlus = DialogPlus.newDialog(holder.description.getContext())
                        .setContentHolder(new ViewHolder(R.layout.okit20133290_update_popup))
                ...
                datePicker.updateDate( d.getDate(), d.getMonth(),d.getYear() + 1900);
                ...
                btnUp.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!(description.getText().toString()).matches(desPattern))
                            ...
                            con.getRef().child(PointsCommunS.VACANCY).child(getRef(mLastPosition).getKey()).updateChildren(map)
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Supprimer", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        con.getRef().child(PointsCommunS.VACANCY).child(getRef(mLastPosition).getKey()).removeValue();
